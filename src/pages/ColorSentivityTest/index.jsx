...
const ColorSentivityTest = () => {
  ...
  return (
    <div className={style.container}>
      <CommonBackToHome />
      <div className={style.title}>颜色敏感度测试</div>
      {
        round > 0 && <div className={style.pagesText}>第 {round}/10 轮</div>
      }
      {
        round > 0 ? (
          <div className={style.rectsContainer}>
            {
              // 生成 16 个 div
          ...
          <div className={style.begainButton} onClick={handleBegain}>点击开始</div>
        )
      }
